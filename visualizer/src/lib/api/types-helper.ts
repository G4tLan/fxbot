...
export type TradeResult = components['schemas']['TradeResult'];
...
export type MessageResponse =
  components['schemas']['engine__controllers__auth_controller__MessageResponse'];
...
export type BacktestSessionListResponse = components['schemas']['BacktestSessionListResponse'];
export type ChartDataResponse = components['schemas']['ChartDataResponse'];
export type StrategyCodeResponse = components['schemas']['StrategyCodeResponse'];
export type UpdateSessionNotesRequest = components['schemas']['UpdateSessionNotesRequest'];
export type PaginationRequest = components['schemas']['PaginationRequest'];
export type ClosedTradeResult = components['schemas']['ClosedTradeResult'];
export type BacktestSessionResponse = components['schemas']['BacktestSessionResponse'];
export type LogsResponse = components['schemas']['LogsResponse'];
export type PurgeResponse = components['schemas']['PurgeResponse'];
export type UpdateSessionStateRequest = components['schemas']['UpdateSessionStateRequest'];
